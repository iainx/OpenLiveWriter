...
# OLW_ASSEMBLIES="/assembly:$OLW_DLL_PATH/OpenLiveWriter.MacPlatform.dll"

NATIVE_REFERENCES="/native-reference:$MONO_PATH/Libraries/libgdiplus.dylib"

MMP_OPTIONS="/verbose /debug /output:. /name:$APP_NAME /arch:x86_64 /sgen /new-refcount /profiling /nolink /profile:4.5"
